            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-col w-full h-full p-5">
                    ...
                    <div class="About-Company">
                        ...
                        <div class="mt-2">
                            National University (NU) Baliwag is a distinguished institution of higher education situated
                            in Baliwag, Bulacan, Philippines. Committed to academic excellence, innovation, and social
