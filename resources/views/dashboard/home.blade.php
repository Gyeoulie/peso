            ...
            <div class="bg-white shadow rounded-lg p-6 flex flex-col">
                ...
                <div class="relative overflow-x-auto ">
                    ...
                    <ul class="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex mb-3">
                        ...
                        <li class="w-full focus-within:z-10">
                            <a href="#"
                                class="inline-block w-full p-4 bg-white border border-gray-200  hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none">Hired(1)</a>
                        </li>
                        ...
                        <tbody>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <th scope="row"
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="{{ asset('assets/img/peso-1.png') }}"
                                        alt="Jese image">
                                    <div class="ps-3 text-wrap">
                                        <div class="text-base font-semibold">Santos, Hans Willy</div>
                                    </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-base font-semibold">July 20, 2020</div>
                                </td>
                                <td class="px-6 py-4">
