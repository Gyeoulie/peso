...
<div class="post-section hidden py-3" id="step2">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6">
            ...
            <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-5 w-full">
                <div class="flex flex-col w-full">
                    ...
                    <p class="mt-1 text-sm text-gray-500 0" id="file_input_help">SVG, PNG, JPG or GIF (MAX.
                        800x400px).</p>
                </div>
            ...
            <div class="pb-4 bg-white">
                ...
                <div class="relative mt-1 p-1">
                    ...
                    <input type="text" id="table-search"
                        class="block w-full pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 bg-white-700"
...
<script>
    function nextSection(sectionnum) {
        // Hide all sections
        console.log("hello")
        var allSections = document.querySelectorAll('.post-section');
        for (var i = 0; i < allSections.length; i++) {
            allSections[i].classList.add("hidden");
        }

        // Show the specified section
        var sectionToShow = document.getElementById('step' + sectionnum);
        if (sectionToShow) {
