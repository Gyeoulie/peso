        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <tr class="bg-white border-b ">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-row gap-1">
                                    <div class="max-w-auto bg-red-300 rounded-lg p-1">
            ...
            <div>
                ...
                <textarea id="editor" rows="4"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 p-20 m-5"
