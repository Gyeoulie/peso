                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                                    ...
                                    <div class="ps-3 text-wrap">
                                        <div class="text-base font-semibold">National University Baliwag</div>
                                        <div class="font-normal text-gray-500 text-sm">SM Baliwag
                                            Complex, Doña
                                            Remedios Trinidad, Highway, Brgy. Pagala, Baliuag, Bulacan 3006
                                        </div>
                                    </div>

                                </th>
                                <td class="px-6 py-4">
                                    <div class="text-base font-semibold">React</div>
                                </td>
                                <td class="px-6 py-4">
                                    Full Time
                                </td>
