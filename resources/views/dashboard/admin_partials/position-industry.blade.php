                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <th scope="row"
                                    ...
                                    <div class="ps-3 text-wrap">
                                        <div class="text-base font-semibold">333</div>

                                    </div>
                                </th>
                                <td class="px-6 py-4">
                                    <div class="text-base font-semibold">Professor</div>
                                </td>
                        ...
                        <tbody>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <th scope="row"
                                    class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                                    <div class="ps-3 text-wrap">
                                        <div class="text-base font-semibold">412</div>

                                    </div>
                                </th>
                                <td class="px-6 py-4">
                                    <div class="text-base font-semibold">School</div>
                                </td>
    ...
    <div class="w-full max-w-4xl px-6 py-6 items-center border-b">
        ...
        <div class="flex flex-col mt-2">
            <div class="flex flex-col mt-2 w-full">
                <x-input-label for="eligibilityType" :value="__('Job Position Title')" />
...
<x-modal name="industry-modal" focusable>
    <div class="w-full max-w-4xl px-6 py-6 items-center border-b">
        ...
        <div class="flex flex-col mt-2">
            <div class="flex flex-col mt-2 w-full">
                <x-input-label for="eligibilityType" :value="__('Industry Title')" />
                <x-text-input id="fname" class="block mt-1 w-full" type="text" name="fnamePost" />
            </div>
            <div class="flex flex-col mt-2 w-full">
                <x-input-label for="eligibilityType" :value="__('Status')" />
