            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="relative overflow-x-auto">
                    <div
                        ...
                        <div>
                            <button type="button" class="inline-flex text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 focus:outline-none">Add Requirement</button>
                        </div>
                    </div>
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-base font-semibold">PDF</div>
                                </td>
                                <td class="px-6 py-4">
