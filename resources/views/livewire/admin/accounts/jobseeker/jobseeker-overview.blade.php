<div class="container mx-auto py-8">
    ...
    <x-modal name="deactivate-modal" focusable>
        <div class="w-full px-6 py-6 mx-auto bg-white rounded-lg shadow-lg border border-gray-200">
            ...
            <div class="flex flex-col items-center my-6">
                <div class="text-center">
                    <span class="text-lg font-semibold text-gray-800">Are you sure you want to deactivate this
                        jobseeker's account?</span>
                </div>
            </div>
            <div class="flex justify-end space-x-4 mt-6">
                <x-secondary-button x-on:click="$dispatch('close-modal', 'deactivate-modal')"
                    class="bg-gray-200 text-gray-800 hover:bg-gray-300 transition-colors duration-300">
                    {{ __('Cancel') }}
                </x-secondary-button>

                <x-danger-button wire:loading.attr="disabled" wire:target='saveDetails'
                    wire:click.prevent="saveDetails"
                    class="bg-red-500 hover:bg-red-600 text-white transition-transform transform hover:scale-105">
                    {{ __('Confirm') }}
                    <div wire:loading.delay.long wire:target="saveDetails" role="status" class="inline-block ml-2">
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin fill-white"
                            viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                                fill="currentColor" />
