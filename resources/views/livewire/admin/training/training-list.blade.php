                ...
                <div class="relative overflow-x-auto p-1">
                    <div class="sm:hidden">
                        ...
                        <select id="tabs"
                            ...
                            <option wire:click.prevent='updateFilter("ACTIVE")'>Approved</option>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        <th scope="row"
                                            ...
                                            <img class="w-10 h-10 rounded-full"
                                                src="{{ asset('storage/' . $data->program_pubmat) }}" alt="Jese image">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex flex-row  gap-5">
                                                <div x-data="{ tooltip: 'View Job Post Information' }">
                                                    <a wire:navigate {{-- href="{{ route('admin.jobpost', ['id' => $data->job_id]) }}" --}} x-tooltip="tooltip"
                                                        type="button"
                                                ...
                                                <div x-data="{ tooltip: 'View Applicants' }">
                                                    <a wire:navigate {{-- href="{{ route('admin.jobpost.applicants', ['id' => $data->job_id]) }}" --}} x-tooltip="tooltip"
                                                        ...
                                                        <svg class="w-5 h-5 " aria-hidden="true"
                                                            ...
                                                            <path soke="currentColor" stroke-linecap="round"
