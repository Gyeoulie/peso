        ...
        <div class="col-span-4 sm:col-span-12">
            <div class="bg-white shadow rounded-lg p-6" x-data="{
                ...
                <div class="relative overflow-x-auto p-1">
                        <x-primary-button wire:loading.attr="disabled" wire:click.prevent="confirmAction(3)" class="ms-3"
                        type="button">
                        {{ __('Backup Database') }}
                            ...
                            <tbody>
                                @forelse ($files as $file)
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ \Carbon\Carbon::parse($file['date'])->format('F j, Y, h:i:s a') }}
                                        </td>
                                        <td class="px-6 py-4">

                                            <div class="flex flex-row items-center justify-center gap-6">
                                                <div x-data="{ tooltip: 'Restore Database' }">
                                                    <button wire:click.prevent="confirmAction(1,'{{ $file['path'] }}')"
                                                ...
                                                <div x-data="{ tooltip: 'Delete Database' }">
                                                    <button wire:click.prevent="confirmAction(2,'{{ $file['path'] }}')"
                                                        x-tooltip="tooltip" type="button"
