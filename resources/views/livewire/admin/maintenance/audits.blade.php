                ...
                <div class="relative overflow-x-auto p-1">
                    <div class="sm:hidden">
                        ...
                        <select id="tabs"
                            ...
                            <option wire:click.prevent='updateFilter("1")'>System</option>
                            <option wire:click.prevent='updateFilter("2")'>Job Posting</option>
                    ...
                    <ul class="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex mb-3">
                        ...
                        <li wire:click.prevent='updateFilter("1")' class="w-full focus-within:z-10">
                        ...
                        <li wire:click.prevent='updateFilter("2")' class="w-full focus-within:z-10">
                        ...
                        <li wire:click.prevent='updateFilter("3")' class="w-full focus-within:z-10">
                            <button @click="openTab = 4" :class="openTab === 4 ? activeClasses : inactiveClasses"
                                class="inline-block w-full p-4 border-r border-gray-200 focus:ring-1 focus:ring-gray-300 focus:outline-none">Job
                                Applicants</button>
                        </li>
                        <li wire:click.prevent='updateFilter("4")' class="w-full focus-within:z-10">
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach ($formattedAudits as $audit)
                                    <tr wire:key='audit-{{ $loop->index }}' class="bg-white border-b hover:bg-gray-50">
                                        <td class="px-6 py-4">
