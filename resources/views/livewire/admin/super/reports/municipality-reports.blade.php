<div class="container mx-auto py-8">
    ...
    <div class="grid grid-cols-4 lg:grid-cols-12 gap-4 p-3 lg:p-0" x-data="{ selectedAnalytics: @entangle('selectedAnalytics') }">
        ...
        <div class="col-span-2 md:col-span-3">
            <div class="bg-blue-100 shadow rounded-lg p-6 flex flex-col h-full">
                ...
                <div class="flex flex-row w-full justify-between mb-5 mt-auto gap-5">
                    ...
                    <svg class="hidden lg:flex w-12 h-12 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <div class="col-span-2 lg:col-span-3">
            <div class="bg-white shadow rounded-lg p-6 flex flex-col w-full h-full">
                ...
                <div class="flex flex-row justify-between mb-5">
                    ...
                    <svg class="hidden lg:flex w-10 h-10 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="col-span-4">
            <livewire:admin.reports.municipality-partials.barangay-jobseekers municipalityID="{{ $selectedMun }}" />
        </div>

        <div class="col-span-4">
            <livewire:admin.reports.municipality-partials.employment-age-group municipalityID="{{ $selectedMun }}" />
        </div>
        ...
        <div class="col-span-4">
            <livewire:admin.reports.municipality-partials.recommendation-trends municipalityID="{{ $selectedMun }}" />
        </div>
        <div class="col-span-4">
            <livewire:admin.reports.municipality-partials.employment-trends municipalityID="{{ $selectedMun }}" />
        </div>
        <div class="col-span-4">

            <livewire:admin.reports.municipality-partials.job-posting-trends municipalityID="{{ $selectedMun }}" />
        ...
        <div class="col-span-4">
            <livewire:admin.reports.municipality-partials.top-job-tags municipalityID="{{ $selectedMun }}" />

        </div>
        <div class="col-span-4">
            <livewire:admin.reports.municipality-partials.top-job-industry municipalityID="{{ $selectedMun }}" />
        </div>
        <div class="col-span-4">

            <livewire:admin.reports.municipality-partials.top-job-preference municipalityID="{{ $selectedMun }}" />
        </div>
