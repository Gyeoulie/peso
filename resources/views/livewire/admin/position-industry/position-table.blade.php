<div>
    <div class="bg-white shadow rounded-lg p-6">
            ...
            <div
                ...
                <div class="hidden sm:inline-flex">
                    <x-primary-button type="button"
                        ...
                        x-data="" x-on:click.prevent="$dispatch('open-modal', 'jobposition-modal')">Add
                        Job Position</x-primary-button>
                </div>
                    ...
                    @else
                        @foreach ($jobpositions as $data)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="text-gray-500 font-medium text-lg uppercase">{{ $data->position_Code }}
                                    </div>
                                </td>

                                <td class="px-6 py-4">
                                    <div class="text-black font-bold text-lg uppercase">{{ $data->position_Title }}
                                    </div>
                                </td>

                                <td class="px-6 py-4">
                                    <div class="flex flex-row items-center justify-center gap-6">
                                        <button wire:click.prevent='editPos({{ $data->position_id }})'type="button">
        ...
        {{-- PAGINATION --}}
        <div class="mt-4">
            {{ $jobpositions->links('vendor.pagination.tailwind') }}
        </div>
