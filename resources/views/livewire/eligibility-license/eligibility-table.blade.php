        ...
        <div class="flex flex-row mb-4">
            ...
            <div class="mr-0 ml-auto sm:hidden">
                <x-primary-button type="button"
                    ...
                    x-on:click.prevent="$dispatch('open-modal', 'eligibility-modal')">Add Eligibility</x-primary-button>
            </div>
        </div>
            ...
            <div
                ...
                <div class="hidden sm:inline-flex ">
                    <x-primary-button type="button"
                        ...
                        x-data="" x-on:click.prevent="$dispatch('open-modal', 'eligibility-modal')">
                ...
                @endif
                    @foreach ($eligibility as $data)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="text-gray-500 font-medium text-lg uppercase">{{ $data->eligibility_Code }}
                                </div>
                            </td>

                            <td class="px-6 py-4">
                                <div class="text-black font-bold text-lg uppercase">{{ $data->eligibility_Name }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
