    ...
    <div class="w-full max-w-4xl px-6 py-6 items-center border-b">
        ...
        <div class="flex flex-row gap-6 mt-2 w-full">
            ...
            <div class="flex flex-col mt-2 w-full">
                ...
                <x-text-input wire:model='eligibilityPost' id="eligibilityPost" class="block mt-1 w-full uppercase" type="text"
        ...
        <div class="mt-6 flex justify-end">
            ...
            <x-primary-button wire:click.prevent='addEligibility' class="ms-3" type="button" id="eligibilityAdd">
                {{ __('Add Eligibility') }}
            </x-primary-button>
        </div>
    </div>
