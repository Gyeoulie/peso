        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
                ...
                @foreach ($educ as $education)
                    <div wire:key="{{ $education->education_id }}" class="container bg-gray-200 p-3 rounded-lg shadow">
    ...
    <x-modal name="education-modal" focusable>
        <div class="w-full max-w-4xl px-6 py-6 items-center border-b">
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button wire:click.prevent='save' class="ms-3" type="button" id="eduAdd">
                    {{ __('Save') }}
                </x-danger-button>
            </div>
        </div>
