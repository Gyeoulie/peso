    ...
    <x-modal name="certificate-modal" focusable>
        <div class="w-full max-w-4xl px-6 py-6 items-center border-b">
            ...
            <div class="flex flex-col mt-2">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="max-h-[120px] bg-white overflow-y-auto">
                                ...
                                @foreach ($certTypes as $certType)
                                    <x-dropdown-link wire:click.prevent='certtypeid({{ $certType->cert_type_id }})' class="cursor-pointer block px-4 py-2 hover:bg-gray-100 uppercase">
                                        {{ $certType->cert_Name }}
                                    </x-dropdown-link>
                                @endforeach
                ...
                <div class="flex flex-row mt-2 w-full">
                    <div class="flex flex-col w-full">
                        ...
                        <x-text-input wire:model="certEarned" id="certDate" class="block mt-1 w-full" type="date" />
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button wire:click.prevent='save' class="ms-3" type="button" id="certAdd">
                    {{ __('Save') }}
                </x-danger-button>
            </div>
