<div>
    <div x-show="profileTab === 'editCertificates'" class="container">
        <div class="bg-white shadow-lg rounded-lg p-6">
            <div class="flex flex-row w-full items-center justify-between mb-4">
                ...
                <div class="flex flex-row gap-4 items-center">
                    <div class="flex items-center rounded-full hover:bg-gray-300 transition-transform p-1"
                        x-data="" x-on:click.prevent="$dispatch('open-modal', 'certificate-modal')">
                ...
                <div class="container bg-gray-200 p-3 rounded-lg shadow ">
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="flex flex-col ml-4 w-full">
                            <span class="text-2xl text-black font-bold">Certificate</span>
                            <span class="text-lg text-black font-semibold">
                                Cert From
                            </span>
                            <span class="text-sm text-gray-700 font-medium">Rating</span>
                            <span class="text-sm text-gray-700 font-medium">Date Issued</span>
                        </div>
