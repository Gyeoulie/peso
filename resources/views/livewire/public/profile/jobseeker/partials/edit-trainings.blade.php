        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
                @foreach ($trainings as $trainings)
                    <div wire:key="{{ $trainings->training_id }}" class="container bg-gray-200 p-3 rounded-lg shadow ">
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="flex flex-col ml-4 w-full">
                                <span class="text-2xl text-black font-bold">{{$trainings->training_Name}}</span>
                                <span class="text-lg text-black font-semibold">{{$trainings->training_Cert}}
                                </span>
                                <span class="text-sm text-gray-700 font-medium">{{$trainings->training_From}}</span>
            ...
            <div class="flex flex-col mt-2">
                ...
                <div class="flex flex-row mt-2 w-full">
                    <div class="flex flex-col w-full">
                        ...
                        <x-text-input wire:model="trainStart" id="trainingStart" class="block mt-1 w-full" type="date" />
                ...
                <x-text-input wire:model="trainInstitution" id="trainingInsti" class="block mt-1 w-full" type="text" />
                ...
                <div class="flex flex-col mt-2 w-full">
                    ...
                    <x-text-input wire:model="trainCert" id="trainingCert" class="block mt-1 w-full" type="text" />
                ...
                <div class="mt-2">
                    ...
                    <div class="flex items-center">
                        <label for="completeCheckBoxYes" class="mr-2">
                            <input wire:model="trainStat" id="completeCheckBoxYes" type="radio" name="completeCheckBox" value="1"
                                autocomplete="off">
                            <span class="ml-1">{{ __('Yes') }}</span>
                        </label>
                        <label for="completeCheckBoxNo" class="ml-4 mr-2">
                            <input wire:model="trainStat" id="completeCheckBoxNo" type="radio" name="completeCheckBox" value="2"
                                autocomplete="off">
