                        ...
                        @else
                            ...
                            <a href="{{ route('jobpost.show', ['id' => $jobPosts->job_id]) }}" class="group">
                                <div wire:key='{{ $jobPosts->job_id }}' class="container p-3 ">
                                    ...
                                    <div class="flex flex-row h-full items-center bg-white  rounded-lg hover:shadow-lg transition-shadow duration-300 transition-transform duration-300 ease-in-out transform group-hover:scale-105 group-hover:shadow-xl">
