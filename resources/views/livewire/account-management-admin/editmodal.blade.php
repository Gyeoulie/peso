<x-modal name="edit-admin-modal" focusable>
    <div class="w-full max-w-4xl px-6 py-6 items-center border-b">
        ...
        <form wire:submit="update">
            <div class="flex flex-col mt-2">
                ...
                <x-text-input wire:model="idPost" id="password" class="block mt-1 w-2/3" type="hidden" name="pwdPost"
                    value="{{ $pwdPost }}" />
                ...
                <div class="flex flex-col mt-4 w-full">
                    ...
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex flex-col items-center ml-4">
                            ...
                            <x-secondary-button wire:click.prevent="resetPassword" type="button" class="bg-red-400">
                                {{ __('Reset Password') }}
                            </x-secondary-button>
                        </div>
                    </div>
