            ...
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8 ">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <a href="https://flowbite.com/"
                        ...
                        <span
                            class="self-center text-xl md:text-2xl font-semibold whitespace-nowrap ">Public Employment Service Office</span>
                    </a>
                    <ul
                ...
                <span class="block text-sm text-gray-500 sm:text-center ">© 2023 <a
                        href="https://flowbite.com/" class="hover:underline">PESO™</a>. All Rights
                    Reserved.</span>
            </div>
        </footer>
    </body>
