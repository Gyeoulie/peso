<section>
    ...
    <form x-ref="passwordForm" method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        @csrf
        @method('put')
        ...
        <div class="flex items-center gap-4">
            <x-primary-button type="button" x-data=""
                x-on:click.prevent="$dispatch('open-modal', 'confirm-password-change-modal')">{{ __('Save') }}</x-primary-button>
